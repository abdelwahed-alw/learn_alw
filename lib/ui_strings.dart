...
const Map<String, Map<String, String>> _strings = {
  ...
  'en': {
    ...
    'practice': 'Practice',
    'ielts': 'Exams',
    'ieltsExamPrep': 'Official Exam Prep',
    'officialPastExams': 'Official Past Exams',
    'fillBlanksTab': 'Fill Blanks',
    ...
    'learnFirstWordDesc': 'You\'ll learn your first word through a simple sentence. Tap any word you don\'t know to discover its meaning.\n\nFuture sentences will reuse what you\'ve learned, introducing only 1-2 new words at a time.',
    'learnMyFirstWord': 'Learn My First Word',
    'trackYourLearning': 'Track your learning journey',
    'totalExercises': 'Total Exercises',
    'wordsLearned': 'Words Learned',
    'topicBreakdown': 'Topic Breakdown',
    'skillsBreakdown': 'Skills Breakdown',
    'noExercisesYet': 'No exercises completed yet.\nStart practicing to see your progress!',
    'startAnExercise': 'Start an Exercise',
    'appSettings': 'App Settings',
    'darkMode': 'Dark Mode',
    'showTranslationFab': 'Show Floating Translation Button',
    ...
    'skillExercises': 'Skill Exercises',
    'tapWordsToLearn': 'Tap words to learn',
    'targetLegend': 'Target',
    'newLegend': 'New',
    'knownLegend': 'Known',
    'tapToLearnLegend': 'Tap to learn',
    'newWordsInSentence': 'New words in this sentence',
    'add': 'Add',
    'meaning': 'Meaning',
    'example': 'Example',
    ...
    'completeSentenceHint': 'Complete the sentence…',
    'submitCompletion': 'Submit Completion',
    'writingTask': 'Writing Task',
    'writeEssayHint': 'Write your essay here…',
    'submitEvaluation': 'Submit for Evaluation',
    'minCharEvaluation': 'Please write at least 50 characters for a meaningful evaluation.',
    'result': 'Result',
    'goodCompletion': '✓ Good Completion',
    'modelCompletion': 'Model Completion:',
    'estimatedBandScore': 'Estimated Band Score',
  ...
  'ar': {
    ...
    'apiKeyRequired': 'مطلوب لفتح جميع الدروس وميزات التطبيق',
    ...
    'practice': 'تمرين',
    'ielts': 'IELTS',
    'ieltsExamPrep': 'تحضير الاختبارات الرسمية',
    'officialPastExams': 'امتحانات رسمية سابقة',
    'fillBlanksTab': 'املأ الفراغات',
    'completeTab': 'أكمل الجملة',
    'writingTab': 'كتابة',
    'fillBlanksTitle': 'املأ الفراغات',
    'fillBlanksDesc':
        'اقرأ النص واختر الكلمة الصحيحة لملء الفراغ. يختبر فهم القراءة والمفردات.',
    'sentenceCompletionTitle': 'إكمال الجملة',
    'sentenceCompletionDesc':
        'أكمل جذع الجملة بكلماتك الخاصة. سيقوم الذكاء الاصطناعي بتقييم القواعد والسياق.',
    'writingPracticeTitle': 'تدريب الكتابة',
    'writingPracticeDesc':
        'اكتب ردًا كاملاً على سؤال رسمي. احصل على تقدير للدرجة واقتراحات للتحسين.',
    'generateExercise': 'إنشاء تمرين',
    'selectCorrectWord': 'اختر الكلمة الصحيحة:',
    'categories': 'التصنيفات',
    'salearn': 'SaLearn',
    'overallProgress': 'التقدم العام',
    'exercises': 'تمارين',
    'dayStreak': 'التتابع اليومي',
    ...
    'learnFirstWordDesc': 'ستتعلم كلمتك الأولى من خلال جملة بسيطة. اضغط على أي كلمة لا تعرفها لاكتشاف معناها.\n\nالجمل القادمة ستعيد استخدام ما تعلمته، مع تقديم كلمة أو كلمتين جديدتين فقط في كل مرة.',
    'learnMyFirstWord': 'تعلم كلمتي الأولى',
    'trackYourLearning': 'تتبع رحلة تعلمك',
    'totalExercises': 'إجمالي التمارين',
    'wordsLearned': 'الكلمات المتعلّمة',
    'topicBreakdown': 'تفصيل المواضيع',
    'skillsBreakdown': 'تفصيل المهارات',
    'noExercisesYet': 'لم تكمل أي تمارين بعد.\nابدأ التدرب لترى تقدمك!',
    'startAnExercise': 'ابدأ تمريناً',
    'appSettings': 'إعدادات التطبيق',
    'darkMode': 'وضع داكن',
    'showTranslationFab': 'إظهار زر الترجمة العائم',
    'quickTranslation': 'ترجمة سريعة',
    'open': 'فتح',
    'typeTextHere': 'اكتب النص هنا…',
    'chooseAppearance': 'اختر المظهر المفضل',
    'lightMode': 'وضع فاتح',
    'moreWords': 'المزيد من الكلمات',
    'exerciseCategories': 'تصنيفات التمارين',
    'myVocabulary': 'مفرداتي',
    'vocabularyPractice': 'تدريب المفردات',
    'skillExercises': 'تمارين المهارات',
    'tapWordsToLearn': 'اضغط على الكلمات للتعلم',
    'targetLegend': 'الهدف',
    'newLegend': 'جديد',
    'knownLegend': 'معروف',
    'tapToLearnLegend': 'اضغط للتعلم',
    'newWordsInSentence': 'كلمات جديدة في هذه الجملة',
    'add': 'إضافة',
    'meaning': 'المعنى',
    'example': 'مثال',
    'addedToVocabulary': 'تمت الإضافة إلى مفرداتك',
    'selectOptionFirst': 'الرجاء تحديد خيار أولاً.',
    'completeSentence': 'أكمل الجملة',
    'completeSentenceHint': 'أكمل الجملة…',
    'submitCompletion': 'إرسال الإكمال',
    'writingTask': 'مهمة كتابة',
    'writeEssayHint': 'اكتب مقالك هنا…',
    'submitEvaluation': 'إرسال للتقييم',
    'minCharEvaluation': 'الرجاء كتابة 50 حرفًا على الأقل لتقييم مفيد.',
    'result': 'النتيجة',
    'goodCompletion': '✓ إكمال جيد',
    'modelCompletion': 'الإكمال النموذجي:',
    'estimatedBandScore': 'تقدير الدرجة',
    'corrections': 'التصحيحات',
    'vocabularyUpgrades': 'تحسينات المفردات',
    'enterActivationCode': 'الرجاء إدخال كود التفعيل.',
...
const Map<String, Map<String, String>> _topicNames = {
  ...
  'fr': {
    ...
    'Music & Arts': 'Musique et arts',
    'Fashion & Shopping': 'Mode et shopping',
    'Education & Learning': 'Éducation et apprentissage',
  },
  'es': {
  ...
  'tr': {
    ...
    'Weather & Seasons': 'Hava ve mevsimler',
    'Health & Fitness': 'Sağlık ve fitness',
    'Music & Arts': 'Müzik ve sanat',
    'Fashion & Shopping': 'Moda ve alışveriş',
    'Education & Learning': 'Eğitim ve öğrenme',
  },
  'de': {
    ...
    'Music & Arts': 'Musik und Kunst',
    'Fashion & Shopping': 'Mode und Shopping',
  ...
  'it': {
    ...
    'Weather & Seasons': 'Meteo e stagioni',
    'Health & Fitness': 'Salute e fitness',
    'Music & Arts': 'Musica e arte',
    'Fashion & Shopping': 'Moda e shopping',
    'Education & Learning': 'Istruzione e apprendimento',
  },
  'pt': {
    ...
    'Weather & Seasons': 'Clima e estações',
    'Health & Fitness': 'Saúde e condicionamento físico',
    'Music & Arts': 'Música e artes',
    'Fashion & Shopping': 'Moda e compras',
    'Education & Learning': 'Educação e aprendizado',
  },
  'zh': {
  ...
  'ja': {
    ...
    'Music & Arts': '音楽と芸術',
    'Fashion & Shopping': 'ファッションとショッピング',
